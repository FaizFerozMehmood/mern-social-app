...
import { createUser, enhanceUserProfile, getUser, getUsers, login, searchUsers, updateUserInfo } from "../controllers/userController.js";
...
router.put("/enhance/:id", enhanceUserProfile);
